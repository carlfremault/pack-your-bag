...
export type CloneListBody = RequestBody<'/list/{id}/clone', 'post'>;
export type ClonePackBody = RequestBody<'/pack/{id}/clone', 'post'>;
...
export type CollectionForDetailsCardDisplay = CollectionForDisplay & {
  categoryWeights?: {
