...
export class PackController {
  ...
  @Post('/assistant')
  @ApiBffAndAccessSecurity()
  @ApiOperation({ summary: 'Create a pack generated by the AI assistant' })
  @ApiResponse({
  ...
  async createAssistantPack(
    @Body() assistantPack: CreateAssistantPackDto,
    @CurrentUser('userId') userId: string,
  ) {
    return this.packService.createAssistantPack(assistantPack, userId);
  }
